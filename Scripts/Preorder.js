// ============================================================
// REDitors Waitlist System - WITH PASSWORD SUPPORT
...
class PreOrderManager {
    constructor() {
        ...
        this.baseReferralUrl = window.location.origin + window.location.pathname;
        this.init();
    }
    ...
    async init() {
        ...
        console.log('✅ REDitors Waitlist Ready with Password Support');
    }
    ...
    setupWaitlistForm() {
        ...
        const passwordInput = document.getElementById('waitlistPassword');
        const referralInput = document.getElementById('referredByCode');
        ...
        [emailInput, nameInput, passwordInput, referralInput].forEach(input => {
            if (input) {
    ...
    async handleJoinWaitlist() {
        ...
        if (!emailInput || !passwordInput || !joinBtn) {
        ...
        try {
            ...
            if (existingUser) {
                ...
                this.showToast('You\'re already registered! Please use the Login button.', 'error');
                this.resetForm();
                return;
            }
            ...
            console.log('💾 Inserting data with password hash');
            ...
            if (window.reditorsAuth) {
                window.reditorsAuth.currentUser = newUser;
                window.reditorsAuth.showLoggedInUI();
            }
    ...
    // Continue with all other methods from Preorder_v2_REFERRAL.js...
    // (Including validateReferralCode, generateUniqueReferralCode, etc.)
                ...
                <div style="margin-top: 24px; padding: 20px; background: rgba(255, 215, 0, 0.1); border-radius: 12px; border: 2px solid rgba(255, 215, 0, 0.4);">
                    ...
                    <div style="padding: 12px; background: rgba(255, 0, 0, 0.1); border-radius: 6px; border: 1px solid rgba(255, 0, 0, 0.3);">
                        <p style="margin: 0; font-size: 12px; color: #ff6b6b; font-weight: 600;">
                            ⚠️ IMPORTANT: Save this URL! Share it to earn rewards and move up the waitlist.
                        </p>
                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('✅ PreOrder Manager with Password Support Ready');
});